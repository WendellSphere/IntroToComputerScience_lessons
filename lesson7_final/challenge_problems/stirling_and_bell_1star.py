...
def stirling(n,k):
    ...
    if n == k or k ==1:
        return 1
    return k * stirling(n-1,k) + stirling(n-1,k-1) # I insterted this line

def bell(n):
    total = 0
    for k in range(1,n+1):
        total += stirling(n,k) #I insetered this line
    return total     # I instered this line
