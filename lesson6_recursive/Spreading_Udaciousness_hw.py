...
def hexes_to_udaciousness(n, spread, target):
    ...
    # the arthmetic expression on the right of return evauluates before
    # being returned. when the recurisive definition/call equals 0
    # the total of the previous 1's forming total index of hexamesters
    # will be returned. 0 is the base case result which also is the end result
