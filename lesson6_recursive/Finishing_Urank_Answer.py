...
def compute_ranks(graph):
    ...
    for i in range(0, numloops):
      ...
      ############################Answer################################          
        ...
        #############################################################
        # node is each page in the outer loop's current page
        # if page is in the graph[node] aka outlinks for that node
        # then node links to page. These are inlinks to the outer loop page
        # if page is in the graph[node], we update newrank using this prescibed formula
