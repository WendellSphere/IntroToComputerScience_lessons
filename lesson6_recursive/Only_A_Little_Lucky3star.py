...
def ordered_search(index, ranks, keyword):
    ...
    for candidate in pages:
        if ranks[candidate] > pivot:
            morelist.append(candidate)
        elif pivot > ranks[candidate]:
            lesslist.append(candidate)
        else:
            pivotlist.append(candidate)
    return morelist + pivotlist +  lesslist

####my answer above ,professor's below####################################
